...
func (c *setgpioClient) SetPWM(ctx context.Context, in *PWMRequest, opts ...grpc.CallOption) (*PinSetResponse, error) {
	...
	err := c.cc.Invoke(ctx, Setgpio_SetPWM_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *setgpioClient) SetBME280(ctx context.Context, in *BME280Request, opts ...grpc.CallOption) (*PinSetResponse, error) {
	out := new(PinSetResponse)
	err := c.cc.Invoke(ctx, Setgpio_SetBME280_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *setgpioClient) SenseBME280(ctx context.Context, in *PinSetRequest, opts ...grpc.CallOption) (*BME280Response, error) {
	...
	err := c.cc.Invoke(ctx, Setgpio_SenseBME280_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Setgpio_SetPWM_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Setgpio_SetPWM_FullMethodName,
	}
...
func _Setgpio_SetBME280_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Setgpio_SetBME280_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Setgpio_SenseBME280_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Setgpio_SenseBME280_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Setgpio_PWMDutyCycleOutput_BME280TempInput_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Setgpio_PWMDutyCycleOutput_BME280TempInput_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
